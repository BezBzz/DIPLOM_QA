...
public class TripPagePayForm {
    ...
    public static SelenideElement successNotification = $x("//div[contains(@class, 'notification_status_ok')]//div[text()='Операция одобрена Банком.']");
    public static SelenideElement payHeader = $x("//div/h3[text()='Оплата по карте']");
    public static SelenideElement payForm = $x("//div/form");
